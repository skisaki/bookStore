...
def get_book_details(id, headers)
    ...
    return {
        ...
        'price': "29,700원",
        'shipping_fee': '무료',
        'author': '안드레아스 비티히,미하엘 비티히',
        'auth': '안드레아스 비티히,미하엘 비티히',
        'year': 2017,
        'type' => '클라우드',
        'pages' => 504,
        'publisher' => '한빛미디어',
        'Publication_date' => '2017년 05월 01일',
        'contents' => '분산 시스템 개발 및 아키텍처, 알고리즘 거래와 실시간 분석 전문가이자 전 세계를 대상으로 활동하는 컨설턴트다. 둘 다 전문가 등급의 AWS 공인 솔루션 아키텍트로, 독일 툴리우스 발덴(Tullius Walden) 은행의 IT 인프라 전체를 AWS로 옮겼다.',
        'ISBN-10' => '8968483582',
        'ISBN-13' => '9788968483585'
    }
end
